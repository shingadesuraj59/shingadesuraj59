...
- Deployed using Docker on AWS EC2/ECS/ECR, secured with IAM roles  
- Implemented **CI/CD pipelines using GitHub Actions** for automated build & deployment  
...
- MERN inventory & billing app with analytics and WhatsApp notifications  
- Integrated **CI/CD workflow** for automated deployment  
